...
This project is part of the requirements for the **Software Engineering** program at ALX. It aims to teach us about docstrings and how to use them to create and implement tests in **Python**.
