...
Project done during **Software Engineering** program at **ALX**. It aims to teach us about object oriented programming (OOP), classes, objects, instances, methods and attributes in **Python**.
