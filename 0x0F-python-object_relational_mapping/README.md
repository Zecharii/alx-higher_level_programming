...
This project was done as part of the requirements for the **Software Engineering** program at **ALX Africa**. It aims to teach us about MySQL and how to connect to a MySQL database from a Python script, what ORM means and how to map a Python Class to a MySQL table.

## Technologies
* All databases are executed with `MySQL 5.7` version `5.7.8-rc`
