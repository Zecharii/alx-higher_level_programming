# Inheritance
This project is part of the requirements for the Software Engineering program at ALX. It aims to teach us about inheritance, superclass, baseclass and subclass in **Python**.
