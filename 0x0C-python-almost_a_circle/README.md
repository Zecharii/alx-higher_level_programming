# Almost a circle
This is a project carried out during the **ALX Software Engineering** program. It aims to teach us about unit testing, serialization, deserialization, JSON, `args` and `kwargs` in **Python**.
