# Input/Output
Project done during **Software Engineering** program at **ALX**. It aims to teach us how to open, read, write and append files from a script in **Python**.

## Technologies
* Python Scripts are written with Python 3.8.5
* Tested on Ubuntu 20.04 LTS
* Code style is checked using pycodestyle (version 2.8.*)
